...
# Keep the variable defined for `set -u`, but leave it empty unless the caller
# explicitly requests the legacy libstdc++ ABI.
export LEGACY_GLIBCXX_ABI="${LEGACY_GLIBCXX_ABI-}"
